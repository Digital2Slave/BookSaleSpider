...
if (__name__=='__main__'):
    ...
    # MongoDB collection
    #YearCollection  = db['Amazon']
    #MonthCollection = db['AmazonMonth']   
    #AmazonToMongoDB(YearCollection, MonthCollection)
    
    #YearCollection  = db['DangdangYear']
    #MonthCollection = db['DangdangMonth']
    #DangdangToMongoDB(YearCollection, MonthCollection)    

    YearCollection   = db['JingdongYear']
    MonthCollection  = db['JingdongMonth']
    JingdongToMongoDB(YearCollection, MonthCollection)
